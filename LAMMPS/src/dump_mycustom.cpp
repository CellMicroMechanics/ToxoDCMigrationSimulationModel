...
DumpMyCustom::DumpMyCustom(LAMMPS *lmp, int narg, char **arg) :
...
void DumpMyCustom::init_style()
{
  ...
  if (binary && domain->triclinic == 0)
    header_choice = &DumpMyCustom::header_binary;
  else if (binary && domain->triclinic == 1)
    header_choice = &DumpMyCustom::header_binary_triclinic;
  else if (!binary && domain->triclinic == 0)
    header_choice = &DumpMyCustom::header_item;
  else if (!binary && domain->triclinic == 1)
    header_choice = &DumpMyCustom::header_item_triclinic;

  if (binary) write_choice = &DumpMyCustom::write_binary;
  else if (buffer_flag == 1) write_choice = &DumpMyCustom::write_string;
  else write_choice = &DumpMyCustom::write_lines;
...
void DumpMyCustom::write_header(bigint ndump)
{
...
void DumpMyCustom::format_magic_string_binary()
{
...
void DumpMyCustom::format_endian_binary()
{
  int endian = ENDIAN;
...
void DumpMyCustom::format_revision_binary()
{
...
void DumpMyCustom::header_unit_style_binary()
{
  int len = 0;
...
void DumpMyCustom::header_columns_binary()
{
...
void DumpMyCustom::header_time_binary()
{
...
void DumpMyCustom::header_format_binary()
{
...
void DumpMyCustom::header_binary(bigint ndump)
{
...
void DumpMyCustom::header_binary_triclinic(bigint ndump)
{
  header_format_binary();
...
void DumpMyCustom::header_item(bigint ndump)
{
  if (unit_flag && !unit_count) {
    ++unit_count;
...
void DumpMyCustom::header_item_triclinic(bigint ndump)
{
  if (unit_flag && !unit_count) {
    ++unit_count;
    fmt::print(fp,"ITEM: UNITS\n{}\n",update->unit_style);
...
void DumpMyCustom::pack(tagint *ids)
{
...
int DumpMyCustom::convert_string(int n, double *mybuf)
{
  int i,j;
...
void DumpMyCustom::write_data(int n, double *mybuf)
{
...
void DumpMyCustom::write_binary(int n, double *mybuf)
{
  n *= size_one;
...
void DumpMyCustom::write_string(int n, double *mybuf)
{
  if (mybuf)
...
void DumpMyCustom::write_lines(int n, double *mybuf)
{
  int i,j;
...
int DumpMyCustom::parse_fields(int narg, char **arg)
{
  // customize by adding to if statement
  ...
  for (int iarg = 0; iarg < narg; iarg++) {
    if (strcmp(arg[iarg],"id") == 0) {
      pack_choice[iarg] = &DumpMyCustom::pack_id;
      ...
      pack_choice[iarg] = &DumpMyCustom::pack_molecule;
      if (sizeof(tagint) == sizeof(smallint)) vtype[iarg] = Dump::INT;
      else vtype[iarg] = Dump::BIGINT;
    } else if (strcmp(arg[iarg],"proc") == 0) {
      pack_choice[iarg] = &DumpMyCustom::pack_proc;
      vtype[iarg] = Dump::INT;
    } else if (strcmp(arg[iarg],"procp1") == 0) {
      pack_choice[iarg] = &DumpMyCustom::pack_procp1;
      vtype[iarg] = Dump::INT;
    } else if (strcmp(arg[iarg],"type") == 0) {
      pack_choice[iarg] = &DumpMyCustom::pack_type;
      vtype[iarg] = Dump::INT;
    } else if (strcmp(arg[iarg],"element") == 0) {
      pack_choice[iarg] = &DumpMyCustom::pack_type;
      vtype[iarg] = Dump::STRING;
    } else if (strcmp(arg[iarg],"mass") == 0) {
      pack_choice[iarg] = &DumpMyCustom::pack_mass;
      vtype[iarg] = Dump::DOUBLE;

    } else if (strcmp(arg[iarg],"x") == 0) {
      pack_choice[iarg] = &DumpMyCustom::pack_x;
      vtype[iarg] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"y") == 0) {
      pack_choice[iarg] = &DumpMyCustom::pack_y;
      vtype[iarg] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"z") == 0) {
      pack_choice[iarg] = &DumpMyCustom::pack_z;
      vtype[iarg] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"xs") == 0) {
      if (domain->triclinic) pack_choice[iarg] = &DumpMyCustom::pack_xs_triclinic;
      else pack_choice[iarg] = &DumpMyCustom::pack_xs;
      vtype[iarg] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"ys") == 0) {
      if (domain->triclinic) pack_choice[iarg] = &DumpMyCustom::pack_ys_triclinic;
      else pack_choice[iarg] = &DumpMyCustom::pack_ys;
      vtype[iarg] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"zs") == 0) {
      if (domain->triclinic) pack_choice[iarg] = &DumpMyCustom::pack_zs_triclinic;
      else pack_choice[iarg] = &DumpMyCustom::pack_zs;
      vtype[iarg] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"xu") == 0) {
      if (domain->triclinic) pack_choice[iarg] = &DumpMyCustom::pack_xu_triclinic;
      else pack_choice[iarg] = &DumpMyCustom::pack_xu;
      vtype[iarg] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"yu") == 0) {
      if (domain->triclinic) pack_choice[iarg] = &DumpMyCustom::pack_yu_triclinic;
      else pack_choice[iarg] = &DumpMyCustom::pack_yu;
      vtype[iarg] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"zu") == 0) {
      if (domain->triclinic) pack_choice[iarg] = &DumpMyCustom::pack_zu_triclinic;
      else pack_choice[iarg] = &DumpMyCustom::pack_zu;
      vtype[iarg] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"xsu") == 0) {
      if (domain->triclinic) pack_choice[iarg] = &DumpMyCustom::pack_xsu_triclinic;
      else pack_choice[iarg] = &DumpMyCustom::pack_xsu;
      vtype[iarg] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"ysu") == 0) {
      if (domain->triclinic) pack_choice[iarg] = &DumpMyCustom::pack_ysu_triclinic;
      else pack_choice[iarg] = &DumpMyCustom::pack_ysu;
      vtype[iarg] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"zsu") == 0) {
      if (domain->triclinic) pack_choice[iarg] = &DumpMyCustom::pack_zsu_triclinic;
      else pack_choice[iarg] = &DumpMyCustom::pack_zsu;
      vtype[iarg] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"ix") == 0) {
      pack_choice[iarg] = &DumpMyCustom::pack_ix;
      vtype[iarg] = Dump::INT;
    } else if (strcmp(arg[iarg],"iy") == 0) {
      pack_choice[iarg] = &DumpMyCustom::pack_iy;
      vtype[iarg] = Dump::INT;
    } else if (strcmp(arg[iarg],"iz") == 0) {
      pack_choice[iarg] = &DumpMyCustom::pack_iz;
      vtype[iarg] = Dump::INT;

    } else if (strcmp(arg[iarg],"vx") == 0) {
      pack_choice[iarg] = &DumpMyCustom::pack_vx;
      vtype[iarg] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"vy") == 0) {
      pack_choice[iarg] = &DumpMyCustom::pack_vy;
      vtype[iarg] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"vz") == 0) {
      pack_choice[iarg] = &DumpMyCustom::pack_vz;
      vtype[iarg] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"fx") == 0) {
      pack_choice[iarg] = &DumpMyCustom::pack_fx;
      vtype[iarg] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"fy") == 0) {
      pack_choice[iarg] = &DumpMyCustom::pack_fy;
      vtype[iarg] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"fz") == 0) {
      pack_choice[iarg] = &DumpMyCustom::pack_fz;
      vtype[iarg] = Dump::DOUBLE;

    } else if (strcmp(arg[iarg],"q") == 0) {
      if (!atom->q_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[iarg] = &DumpMyCustom::pack_q;
      vtype[iarg] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"mux") == 0) {
      if (!atom->mu_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[iarg] = &DumpMyCustom::pack_mux;
      vtype[iarg] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"muy") == 0) {
      if (!atom->mu_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[iarg] = &DumpMyCustom::pack_muy;
      vtype[iarg] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"muz") == 0) {
      if (!atom->mu_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[iarg] = &DumpMyCustom::pack_muz;
      vtype[iarg] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"mu") == 0) {
      if (!atom->mu_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[iarg] = &DumpMyCustom::pack_mu;
      vtype[iarg] = Dump::DOUBLE;

    } else if (strcmp(arg[iarg],"radius") == 0) {
      if (!atom->radius_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[iarg] = &DumpMyCustom::pack_radius;
      vtype[iarg] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"diameter") == 0) {
      if (!atom->radius_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[iarg] = &DumpMyCustom::pack_diameter;
      vtype[iarg] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"heatflow") == 0) {
      if (!atom->heatflow_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[iarg] = &DumpMyCustom::pack_heatflow;
      vtype[iarg] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"temperature") == 0) {
      if (!atom->temperature_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[iarg] = &DumpMyCustom::pack_temperature;
      vtype[iarg] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"omegax") == 0) {
      if (!atom->omega_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[iarg] = &DumpMyCustom::pack_omegax;
      vtype[iarg] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"omegay") == 0) {
      if (!atom->omega_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[iarg] = &DumpMyCustom::pack_omegay;
      vtype[iarg] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"omegaz") == 0) {
      if (!atom->omega_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[iarg] = &DumpMyCustom::pack_omegaz;
      vtype[iarg] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"angmomx") == 0) {
      if (!atom->angmom_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[iarg] = &DumpMyCustom::pack_angmomx;
      vtype[iarg] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"angmomy") == 0) {
      if (!atom->angmom_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[iarg] = &DumpMyCustom::pack_angmomy;
      vtype[iarg] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"angmomz") == 0) {
      if (!atom->angmom_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[iarg] = &DumpMyCustom::pack_angmomz;
      vtype[iarg] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"tqx") == 0) {
      if (!atom->torque_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[iarg] = &DumpMyCustom::pack_tqx;
      vtype[iarg] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"tqy") == 0) {
      if (!atom->torque_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[iarg] = &DumpMyCustom::pack_tqy;
      vtype[iarg] = Dump::DOUBLE;
    } else if (strcmp(arg[iarg],"tqz") == 0) {
      if (!atom->torque_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[iarg] = &DumpMyCustom::pack_tqz;
      vtype[iarg] = Dump::DOUBLE;
    } else if(strcmp(arg[iarg],"age") == 0) {

      if(!atom->age_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[iarg] = &DumpMyCustom::pack_age;
    ...
    // compute or fix or variable or custom vector/array
      ...
      case ArgInfo::COMPUTE:
        pack_choice[iarg] = &DumpMyCustom::pack_compute;
        vtype[iarg] = Dump::DOUBLE;
      ...
      case ArgInfo::FIX:
        pack_choice[iarg] = &DumpMyCustom::pack_fix;
        vtype[iarg] = Dump::DOUBLE;
      ...
      case ArgInfo::VARIABLE:
        pack_choice[iarg] = &DumpMyCustom::pack_variable;
        vtype[iarg] = Dump::DOUBLE;
      ...
      case ArgInfo::DNAME:
        pack_choice[iarg] = &DumpMyCustom::pack_custom;
        vtype[iarg] = Dump::DOUBLE;
...
int DumpMyCustom::add_compute(const char *id)
{
  int icompute;
...
int DumpMyCustom::add_fix(const char *id)
{
  int ifix;
...
int DumpMyCustom::add_variable(const char *id)
{
  int ivariable;
...
int DumpMyCustom::add_custom(const char *id, int flag)
{
  int icustom;
...
int DumpMyCustom::modify_param(int narg, char **arg)
{
...
double DumpMyCustom::memory_usage()
{
...
void DumpMyCustom::pack_compute(int n)
{
...
void DumpMyCustom::pack_fix(int n)
{
...
void DumpMyCustom::pack_variable(int n)
{
...
void DumpMyCustom::pack_custom(int n)
{
...
void DumpMyCustom::pack_id(int n)
{
  tagint *tag = atom->tag;
...
void DumpMyCustom::pack_molecule(int n)
{
  tagint *molecule = atom->molecule;
...
void DumpMyCustom::pack_proc(int n)
{
  for (int i = 0; i < nchoose; i++) {
    buf[n] = me;
    n += size_one;
...
void DumpMyCustom::pack_procp1(int n)
{
  for (int i = 0; i < nchoose; i++) {
    buf[n] = me+1;
    n += size_one;
...
void DumpMyCustom::pack_type(int n)
{
  int *type = atom->type;
...
void DumpMyCustom::pack_mass(int n)
{
  int *type = atom->type;
  double *mass = atom->mass;
...
void DumpMyCustom::pack_x(int n)
{
  double **x = atom->x;
...
void DumpMyCustom::pack_y(int n)
{
  double **x = atom->x;
...
void DumpMyCustom::pack_z(int n)
{
  double **x = atom->x;
...
void DumpMyCustom::pack_xs(int n)
{
  double **x = atom->x;
...
void DumpMyCustom::pack_ys(int n)
{
  double **x = atom->x;
...
void DumpMyCustom::pack_zs(int n)
{
  double **x = atom->x;
...
void DumpMyCustom::pack_xs_triclinic(int n)
{
  int j;
  double **x = atom->x;
...
void DumpMyCustom::pack_ys_triclinic(int n)
{
  int j;
  double **x = atom->x;
...
void DumpMyCustom::pack_zs_triclinic(int n)
{
  double **x = atom->x;
...
void DumpMyCustom::pack_xu(int n)
{
  int j;
  double **x = atom->x;
  imageint *image = atom->image;
...
void DumpMyCustom::pack_yu(int n)
{
  int j;
  double **x = atom->x;
  imageint *image = atom->image;
...
void DumpMyCustom::pack_zu(int n)
{
  int j;
  double **x = atom->x;
  imageint *image = atom->image;
...
void DumpMyCustom::pack_xu_triclinic(int n)
{
  int j;
  double **x = atom->x;
  imageint *image = atom->image;
...
void DumpMyCustom::pack_yu_triclinic(int n)
{
  int j;
  double **x = atom->x;
  imageint *image = atom->image;
...
void DumpMyCustom::pack_zu_triclinic(int n)
{
  int j;
  double **x = atom->x;
  imageint *image = atom->image;
...
void DumpMyCustom::pack_xsu(int n)
{
  int j;
  double **x = atom->x;
  imageint *image = atom->image;
...
void DumpMyCustom::pack_ysu(int n)
{
  int j;
  double **x = atom->x;
  imageint *image = atom->image;
...
void DumpMyCustom::pack_zsu(int n)
{
  int j;
  double **x = atom->x;
  imageint *image = atom->image;
...
void DumpMyCustom::pack_xsu_triclinic(int n)
{
  int j;
  double **x = atom->x;
  imageint *image = atom->image;
...
void DumpMyCustom::pack_ysu_triclinic(int n)
{
  int j;
  double **x = atom->x;
  imageint *image = atom->image;
...
void DumpMyCustom::pack_zsu_triclinic(int n)
{
  int j;
  double **x = atom->x;
  imageint *image = atom->image;
...
void DumpMyCustom::pack_ix(int n)
{
  imageint *image = atom->image;
...
void DumpMyCustom::pack_iy(int n)
{
  imageint *image = atom->image;
...
void DumpMyCustom::pack_iz(int n)
{
  imageint *image = atom->image;
...
void DumpMyCustom::pack_vx(int n)
{
  double **v = atom->v;
...
void DumpMyCustom::pack_vy(int n)
{
  double **v = atom->v;
...
void DumpMyCustom::pack_vz(int n)
{
  double **v = atom->v;
...
void DumpMyCustom::pack_fx(int n)
{
  double **f = atom->f;
...
void DumpMyCustom::pack_fy(int n)
{
  double **f = atom->f;
...
void DumpMyCustom::pack_fz(int n)
{
  double **f = atom->f;
...
void DumpMyCustom::pack_q(int n)
{
  double *q = atom->q;
...
void DumpMyCustom::pack_mux(int n)
{
  double **mu = atom->mu;
...
void DumpMyCustom::pack_muy(int n)
{
  double **mu = atom->mu;
...
void DumpMyCustom::pack_muz(int n)
{
  double **mu = atom->mu;
...
void DumpMyCustom::pack_mu(int n)
{
  double **mu = atom->mu;
...
void DumpMyCustom::pack_radius(int n)
{
  double *radius = atom->radius;
...
void DumpMyCustom::pack_diameter(int n)
{
  double *radius = atom->radius;
...
void DumpMyCustom::pack_heatflow(int n)
{
...
void DumpMyCustom::pack_temperature(int n)
{
...
void DumpMyCustom::pack_omegax(int n)
{
...
void DumpMyCustom::pack_omegay(int n)
{
  double **omega = atom->omega;
...
void DumpMyCustom::pack_omegaz(int n)
{
  double **omega = atom->omega;
...
void DumpMyCustom::pack_angmomx(int n)
{
...
void DumpMyCustom::pack_angmomy(int n)
{
  double **angmom = atom->angmom;
...
void DumpMyCustom::pack_angmomz(int n)
{
  double **angmom = atom->angmom;
...
void DumpMyCustom::pack_tqx(int n)
{
...
void DumpMyCustom::pack_tqy(int n)
{
  double **torque = atom->torque;
...
void DumpMyCustom::pack_tqz(int n)
{
  double **torque = atom->torque;
...
// myatomic 
void DumpMyCustom::pack_age(int n)
{
  int *age = atom->age;
