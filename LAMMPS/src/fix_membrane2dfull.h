#ifdef FIX_CLASS
// clang-format off
FixStyle(membrane2dfull, FixMembrane2dFull);
// clang-format on
#else

#ifndef LMP_FIX_MEMBRANE2DFULL_H
#define LMP_FIX_MEMBRANE2DFULL_H
...
namespace LAMMPS_NS
{
	class FixMembrane2dFull : public Fix
	{
	public:
		FixMembrane2dFull(class LAMMPS *, int, char **);
	...
	private:
		...
		double rate_lo, rate_hi, alpha; //  factors control depolymerization rate
		...
		int tension_flag;//, tension_dynamic_flag; // flags for tension
