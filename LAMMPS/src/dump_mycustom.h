...
#ifdef DUMP_CLASS
// clang-format off
DumpStyle(mycustom,DumpMyCustom);
// clang-format on
#else

#ifndef LMP_DUMP_MYCUSTOM_H
#define LMP_DUMP_MYCUSTOM_H

#include "dump.h"

namespace LAMMPS_NS {

class DumpMyCustom : public Dump {
 public:
  DumpMyCustom(class LAMMPS *, int, char **);
  ~DumpMyCustom() override;
 ...
 protected:
  ...
  typedef void (DumpMyCustom::*FnPtrHeader)(bigint);
  ...
  typedef void (DumpMyCustom::*FnPtrWrite)(int, double *);
  ...
  typedef void (DumpMyCustom::*FnPtrPack)(int);
