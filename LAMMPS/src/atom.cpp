...
void Atom::peratom_create()
{
  ...
  add_peratom("age",&age,INT,0); // myatomic
  add_peratom("membraneBond",&membraneBond,INT,2); // myatomic
  add_peratom("state",&state,INT,0); // myatomic
  ...
  add_peratom("cc_grad",&cc_grad,DOUBLE,3);
...
void Atom::set_atomflag_defaults()
{
  ...
  age_flag = 0; // myatomic
  membraneBond_flag = 0; // myatomic
  state_flag = 0; // myatomic
}
