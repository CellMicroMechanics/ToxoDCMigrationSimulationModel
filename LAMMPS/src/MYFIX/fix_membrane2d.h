#ifdef FIX_CLASS
// clang-format off
FixStyle(membrane2d, FixMembrane2d);
// clang-format on
#else

#ifndef LMP_FIX_MEMBRANE2D_H
#define LMP_FIX_MEMBRANE2D_H
...
namespace LAMMPS_NS
{
	class FixMembrane2d : public Fix
	{
	public:
		FixMembrane2d(class LAMMPS *, int, char **);
