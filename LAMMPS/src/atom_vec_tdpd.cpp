...
AtomVecTDPD::AtomVecTDPD(LAMMPS *lmp) : AtomVec(lmp)
{
  ...
  fields_grow = {"cc", "cc_flux","cc_grad","vest"};
  fields_copy = {"cc", "cc_grad","vest"};
  fields_comm = {"cc", "cc_grad","vest"};
  fields_comm_vel = {"cc", "cc_grad","vest"};
  fields_reverse = {"cc_flux"};
  fields_border = {"cc","cc_grad","vest"};
  fields_border_vel = {"cc","cc_grad","vest"};
  fields_exchange = {"cc", "cc_grad","vest"};
  fields_restart = {"cc", "cc_grad","vest"};
  fields_create = {"cc", "cc_grad","vest"};
  fields_data_atom = {"id", "type", "x", "cc","cc_grad"};
...
void AtomVecTDPD::process_args(int narg, char **arg)
{
  ...
  atom->add_peratom_change_columns("cc_grad", cc_species*3);
